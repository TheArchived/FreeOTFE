inherited frmFreeOTFEExplorerMain: TfrmFreeOTFEExplorerMain
  ...
  inherited ActionList1: TActionList
    ...
    object actListStyleSmallIcons: TAction
      AutoCheck = True
      Caption = '&Small Icons'
      GroupIndex = 1
    ...
    object actListStyleList: TAction
      AutoCheck = True
      Caption = '&List'
      GroupIndex = 1
    ...
    object actListStyleDetails: TAction
      AutoCheck = True
      Caption = '&Details'
      GroupIndex = 1
    ...
    object actItemProperties: TAction
      Caption = '&Properties...'
    ...
    object actUpDir: TAction
      Caption = 'Up'
      OnExecute = actUpDirExecute
    end
    object actNavigateBack: TAction
      Caption = 'Back'
      OnExecute = actNavigateBackExecute
    end
    object actNavigateForward: TAction
      Caption = 'Forward'
      OnExecute = actNavigateForwardExecute
    end
    object actPlaintextNew: TAction
      Caption = '&New file...'
      Hint = 'New plaintext volume'
      OnExecute = actPlaintextNewExecute
    end
    object actCheckExplorerBarFolders: TAction
      AutoCheck = True
      Caption = 'F&olders'
